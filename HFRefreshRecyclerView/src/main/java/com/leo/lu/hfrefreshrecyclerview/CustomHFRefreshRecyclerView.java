 ...
 */
public class CustomHFRefreshRecyclerView extends HFRefreshRecyclerView {

    public PtrFrameLayout mPtrFrameLayout;

    public CustomHFRefreshRecyclerView(Context context) {
        super(context);
    }

    public CustomHFRefreshRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CustomHFRefreshRecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
